    ...
    sampleData.forEach(
      ...
      totalSkills.forEach( skill => {
        ...
        if(SkillsNotMatched.has(skillString)){
            SkillsNotMatched.set(skillString, SkillsNotMatched.get(skillString)+1);
      ...
      return {topSkillsMatched: [...SkillsMatchedArray.slice(0,5)], topSkillsNotMatched: [...SkillsNotMatchedArray.slice(0,5)], score: scoreTotal };
